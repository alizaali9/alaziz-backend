                ...
                <form id="editQuizForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="quizCategory" name="sub_category">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="quizPrice" name="price">
                        </div>
                        <div class="mb-3">
                            <label for="quizThumbnail" class="form-label text-primary fw-bold">Thumbnail</label>
                            <input type="file" class="form-control" id="quizThumbnail" name="thumbnail">
                        </div>
                    </div>
