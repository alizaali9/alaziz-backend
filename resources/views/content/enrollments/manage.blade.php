    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Enrollments for Courses</h1>
                </div>
                <div class="col-auto">
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <div class="col-auto">
                                <div class="app-search-box">
                                    <form class="app-search-form" method="GET" action="{{ route('manage.enrollment') }}">
                            ...
                            <div class="col-auto">
                                <a class="btn app-btn-secondary"
                                    href="{{ route('manage.enrollment', ['download' => 'csv', 'search' => request()->get('search')]) }}">
                                    ...
                                    <tbody>
                                        @foreach ($enrollments as $enrollment)
                                            <tr>
                                                ...
                                                <td class="cell text-center">{{ $enrollment->course->name }}</td>
                                                ...
                                                <td class="cell d-flex justify-content-center">
                                                    <div class="ps-3">
                                                        <form action="{{ route('enrollments.delete', $enrollment->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
    ...
    <script>
        ...
        document.querySelectorAll('.status-toggle').forEach(toggle => {
            toggle.addEventListener('change', function() {
                ...
                fetch(`/enrollments/${enrollmentId}/toggle-status`, {
                        method: 'PATCH',
                        headers: {
