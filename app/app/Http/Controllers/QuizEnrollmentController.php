...
class QuizEnrollmentController extends Controller
{
    ...
    public function checkEnrollment(Request $request)
    {
        ...
        if ($existingEnrollment) {
            return response()->json(['status' => 200, 'enrolled' => true, 'remaining_tries' => $existingEnrollment->remaining_tries, 'marks_percentage' => $existingEnrollment->marks_percentage], 200);
        }
